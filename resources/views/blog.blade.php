...
@endsection
@section('content')
<main data-barba="container" data-barba-namespace="blog" class="blog">
            ...
            <div class="posts mt-md-n5 p-lg-5 rounded-0 mx-auto ">
                ...
                <div class="post shadow mb-4 p-4 w-100">
                    <div class="row justify-content-between">
                        <div class="title text-orange fs-7 pr-3 mr-n1  pt-3 font-weight-bolder text-right">{{$post->title}}</div>
                        <div class="row no-gutters pl-3">
                            ...
                            <div class="pt-2 pr-2">
                                ...
                                <div class="writer text-right text-orange">{{verta($post->created_at)->formatDifference()}} / {{$post->category->name}}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <a href="{{route('post_show',$post)}}" class="btn-post d-block text-center my-3  w-7-em btn btn-orange"> مشاهده
                        پست </a>
                </div>
                @endforeach
            </div>
